System.register(['angular2/core', 'angular2/router', './common/state.service'], function(exports_1) {
    ...
    var core_1, router_1, state_service_1;
    ...
    return {
        ...
        execute: function() {
            LoggedInRouterOutlet = (function (_super) {
                ...
                function LoggedInRouterOutlet(_elementRef, _loader, _parentRouter, nameAttr, stateService) {
                    var _this = this;
                ...
                LoggedInRouterOutlet = __decorate([
                    ...
                    __metadata('design:paramtypes', [core_1.ElementRef, core_1.DynamicComponentLoader, router_1.Router, String, state_service_1.StateService])
...
//# sourceMappingURL=loggedInRouterOutlet.directive.js.map